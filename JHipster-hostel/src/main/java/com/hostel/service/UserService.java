...
import com.hostel.repository.AuthorityRepository;
import com.hostel.repository.PersistentTokenRepository;
...
import com.hostel.service.util.RandomUtil;
import com.hostel.service.dto.UserDTO;
...
public class UserService {
    ...
    public void removeNotActivatedUsers() {
        ...
        List<User> users = userRepository.findAllByActivatedIsFalseAndCreatedDateBefore(now.minusDays(10));
        for (User user : users) {
